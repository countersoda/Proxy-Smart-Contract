...
contract sampleProxy {
    ...
    bytes32 private constant _SMARTCONTRACTWITHLOGIC_SLOT =
    ...
    function SMARTCONTRACTWITHLOGIC()
        public
        view
        returns (address contractwithlogic)
    {
    ...
    fallback() external payable {
        ...
        // }
        assembly {
            let _impl := sload(_SMARTCONTRACTWITHLOGIC_SLOT)
            let ptr := mload(0x40)
